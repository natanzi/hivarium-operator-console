...
// .wrangler/tmp/bundle-Q3wc12/checked-fetch.js
...
async function handleUpdateCustomer(request, env, customerId, identity) {
...
async function route(request, env, url, identity) {
  ...
  if (resource === "agents") {
    ...
    if (segments.length === 4 && segments[3] === "customers") {
      ...
      const asOf = url.searchParams.get("asOf") || (/* @__PURE__ */ new Date()).toISOString();
      ...
      const rows = results.map((row) => {
        ...
        return {
          ...
          endsAt: row.endsAt || void 0,
          scheduledRevokeAt: row.scheduledRevokeAt || void 0
        };
      });
...
// .wrangler/tmp/bundle-Q3wc12/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Q3wc12/middleware-loader.entry.ts
